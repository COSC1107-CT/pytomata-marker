...
about = {}
with open(os.path.join(here, "pytomata", "__version__.py"), "r") as f:
    exec(f.read(), about)
...
setup(
    ...
    packages=find_packages(include=["pytomata*"]),
    include_package_data=True,
    install_requires=install_requires,
    entry_points={
        "console_scripts": ["pytomata-marker=pytomata.__main__:main"]
    },
    zip_safe=False,
)
